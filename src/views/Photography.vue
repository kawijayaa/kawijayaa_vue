<template>
  <b-container class="photography" align-h="center">
    <b-row class="nav-row">
      <b-col class="nav-col">
        <b-link to=""><b-img class="back" src="../assets/back-arrow.png"></b-img></b-link>
        <b-link href="https://instagram.com/okengsukafoto"><b-img class="logo"
            src="../assets/osf/osf_logo.svg"></b-img></b-link>
      </b-col>
      <b-col class="osf-col">
    ...
    <b-row class="img-row" align-h="center">
      ...
      <b-col class="img-col">
        <b-img class="image" src="../assets/osf/osf_0778.jpg"></b-img>
      </b-col>
      <b-col class="img-col">
